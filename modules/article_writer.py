...
def auto_detect_methodology(intent: str, keyword: str = "") -> str:
    ...
    # Detect theo kiểu bài, không theo ngành cố định.
    evidence_keywords = [
        "nghiên cứu", "bằng chứng", "số liệu", "thống kê", "quy định",
        "tiêu chuẩn", "chứng nhận", "hồ sơ", "rủi ro", "kiểm chứng",
    ]
    ...
    review_keywords = [
        ...
        "giá", "mua ở đâu", "lựa chọn", "so sánh lựa chọn",
    ]
    guide_keywords = [
    ...
    if any(kw in kw_lower for kw in evidence_keywords):
