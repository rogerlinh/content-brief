...
NAVIGATION_HEADING_BLACKLIST = frozenset({
    ...
    # Additional generic navigation labels:
    "từ khóa",
...
# Commercial junk topics — generic content không phù hợp cho site thương mại
# Dùng trong _postprocess_prominence_blacklist
COMMERCIAL_JUNK_TERMS = frozenset({
    "tác động môi trường", "tác động đến môi trường",
    "ảnh hưởng môi trường", "carbon footprint",
    "khí thải", "tái chế", "bền vững",
...
# Universal junk terms
UNIVERSAL_JUNK_TERMS = frozenset({
    "tác động môi trường", "tác động đến môi trường",
    "ảnh hưởng môi trường", "carbon footprint",
})

# Deprecated: do not infer vertical from fixed keyword lists.
BUSINESS_TOPIC_SIGNALS = frozenset()

# Business-model signals for Source Context detection
BUSINESS_MODEL_SIGNALS = frozenset({
    "phân phối", "cung cấp", "đại lý", "nhà máy", "sản xuất",
    "enterprise", "wholesale", "oem", "nhập khẩu", "xuất khẩu",
...
# Commercial junk topics — generic content không phù hợp cho site thương mại
COMMERCIAL_JUNK_KEYWORDS = frozenset({
