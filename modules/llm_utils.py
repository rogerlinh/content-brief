...
def call_llm_outline(client, model: str, messages: list[dict], response_format: Optional[dict] = None) -> str:
...
def call_llm_seo(client, model: str, messages: list[dict], response_format: Optional[dict] = None) -> str:
...
def call_llm_micro(client, model: str, messages: list[dict], response_format: Optional[dict] = None) -> str:
...
def call_llm_koray(client, model: str, messages: list[dict], max_tokens: int = 1000, response_format: Optional[dict] = None) -> str:
