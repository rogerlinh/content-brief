...
4. **ENTITY FUZZY NER (Giải thể chủ quan):** Khi viết về chủ thể/danh từ riêng, luôn kèm mô tả/định nghĩa ở first occurrence. VD: "[Tên entity] ([tên viết tắt]) — [mô tả ngắn dựa trên source context]".

5. **E-E-A-T SIGNALS (Tín hiệu E-E-A-T):** Nội dung phải thể hiện: Experience (kinh nghiệm thực tế), Expertise (chuyên môn ngành), Authoritativeness (bằng chứng/cứ liệu), Trustworthiness (thông tin xác thực). Cite tiêu chuẩn, quy định, nghiên cứu, tài liệu sản phẩm hoặc nguồn dữ liệu phù hợp khi source context/SERP cung cấp.
...
VD đúng:
    [ENTITY] | [Tiêu chuẩn/Quy định] | [Mã hoặc tên nguồn xác thực]
    [ENTITY] | [Quy cách/Thông số] | [Giá trị đo lường hoặc điều kiện áp dụng]
    [ENTITY] | [Bối cảnh sử dụng] | [Nhóm người dùng, use case hoặc tình huống cụ thể]

VD sai:
    [ENTITY] | Thông tin | [ENTITY] là một nội dung cần tìm hiểu...
    [ENTITY] | ... | ... (attribute chung chung, không có giá trị cụ thể)
